...
import cz.hlinkapp.gohlinka2_utils2.R
import cz.hlinkapp.gohlinka2_utils2.dialogs.InfoDialog.Companion.ARG_ACTION_BUTTON_TEXT
import cz.hlinkapp.gohlinka2_utils2.dialogs.InfoDialog.Companion.ARG_CLOSE_BUTTON_TEXT
import cz.hlinkapp.gohlinka2_utils2.dialogs.InfoDialog.Companion.ARG_DESCRIPTION_TEXT
import cz.hlinkapp.gohlinka2_utils2.dialogs.InfoDialog.Companion.ARG_TITLE_TEXT
...
open class InfoDialog : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        if (descriptionText == null) throw IllegalArgumentException("The description must be set using ARG_DESCRIPTION_TEXT") else v.description.text = descriptionText
